# example-data-flag Specification

## Purpose

Marks Bitcoin-node rows derived from synthetic example/demo IPs so analytics, filters, and dashboard rendering can distinguish them from real reconnaissance data. The canonical IP set is drawn exclusively from RFC 5737 documentation ranges to guarantee no collision with publicly routable hosts.
